 ...
 *
 * @package ActiveLAMP\Bundle\TaxonomyBundle\DependencyInjection\Compiler
...
class SerializationPass implements CompilerPassInterface
{
    ...
    private function compileJMS(ContainerBuilder $container)
    {
        ...
        $handler =
            new Definition(
                'ActiveLAMP\\Bundle\\TaxonomyBundle\\Serializer\\Handler\\PluralVocabularyFieldHandler',
                array(
        ...
        $handler =
            new Definition(
                'ActiveLAMP\\Bundle\\TaxonomyBundle\\Serializer\\Handler\\SingularVocabularyFieldHandler',
                array(
                    new Reference('service_container'),
                )
            );
